...
from sklearn.metrics import (
    accuracy_score as exact_match_ratio,
    precision_score,
    recall_score,
    hamming_loss,
    f1_score,
...
def eval_metrics(
    metric="acc", y_pred=None, y_true=None, y2_true=None, lam=None, _binarize_labels=False, bits=5
):
    ...
    if y2_true is None:
        ...
        if metric == "emr":
            return lam * exact_match_ratio(y_true, y_pred) + (1 - lam) * exact_match_ratio(
                y_true, y_pred
            )
